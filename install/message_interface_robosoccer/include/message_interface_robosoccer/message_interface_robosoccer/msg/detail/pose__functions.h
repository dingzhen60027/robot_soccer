...
#ifndef MESSAGE_INTERFACE_ROBOSOCCER__MSG__DETAIL__POSE__FUNCTIONS_H_
#define MESSAGE_INTERFACE_ROBOSOCCER__MSG__DETAIL__POSE__FUNCTIONS_H_
 ...
 * calls
 * message_interface_robosoccer__msg__Pose__init().
...
/**
 * It calls
 * message_interface_robosoccer__msg__Pose__fini()
 ...
 * message_interface_robosoccer__msg__Pose__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * message_interface_robosoccer__msg__Pose__Sequence__fini()
 * on the array,
...
#endif  // MESSAGE_INTERFACE_ROBOSOCCER__MSG__DETAIL__POSE__FUNCTIONS_H_
