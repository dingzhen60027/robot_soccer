...
{
  new (message_memory) message_interface_robosoccer::msg::Image(_init);
}

void Image_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message_interface_robosoccer::msg::Image *>(message_memory);
  typed_message->~Image();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Image_message_member_array[1] = {
  {
    ...
    offsetof(message_interface_robosoccer::msg::Image, image),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Image_message_members = {
  ...
  "Image",  // message name
  1,  // number of fields
  sizeof(message_interface_robosoccer::msg::Image),
...
{
  return &::message_interface_robosoccer::msg::rosidl_typesupport_introspection_cpp::Image_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_interface_robosoccer, msg, Image)() {
  return &::message_interface_robosoccer::msg::rosidl_typesupport_introspection_cpp::Image_message_type_support_handle;
}
