...
{
  new (message_memory) message_interface_robosoccer::msg::Pose(_init);
}

void Pose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message_interface_robosoccer::msg::Pose *>(message_memory);
  typed_message->~Pose();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pose_message_member_array[3] = {
  {
    ...
    offsetof(message_interface_robosoccer::msg::Pose, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_interface_robosoccer::msg::Pose, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_interface_robosoccer::msg::Pose, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Pose_message_members = {
  ...
  "Pose",  // message name
  3,  // number of fields
  sizeof(message_interface_robosoccer::msg::Pose),
...
get_message_type_support_handle<message_interface_robosoccer::msg::Pose>()
{
  return &::message_interface_robosoccer::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_interface_robosoccer, msg, Pose)() {
  return &::message_interface_robosoccer::msg::rosidl_typesupport_introspection_cpp::Pose_message_type_support_handle;
}
