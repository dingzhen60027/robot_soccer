...
#ifndef MESSAGE_INTERFACE_ROBOSOCCER__MSG__DETAIL__POSE__TYPE_SUPPORT_H_
#define MESSAGE_INTERFACE_ROBOSOCCER__MSG__DETAIL__POSE__TYPE_SUPPORT_H_
...
#endif  // MESSAGE_INTERFACE_ROBOSOCCER__MSG__DETAIL__POSE__TYPE_SUPPORT_H_
