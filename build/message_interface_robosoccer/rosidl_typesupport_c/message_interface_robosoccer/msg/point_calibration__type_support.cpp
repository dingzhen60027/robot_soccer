...
static const _PointCalibration_type_support_symbol_names_t _PointCalibration_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_interface_robosoccer, msg, PointCalibration)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, message_interface_robosoccer, msg, PointCalibration)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, message_interface_robosoccer, msg, PointCalibration)() {
  return &::message_interface_robosoccer::msg::rosidl_typesupport_c::PointCalibration_message_type_support_handle;
}
