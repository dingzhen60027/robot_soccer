...
static const _ArrayThreshold_type_support_symbol_names_t _ArrayThreshold_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_interface_robosoccer, msg, ArrayThreshold)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, message_interface_robosoccer, msg, ArrayThreshold)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, message_interface_robosoccer, msg, ArrayThreshold)() {
  return &::message_interface_robosoccer::msg::rosidl_typesupport_c::ArrayThreshold_message_type_support_handle;
}
