...
class Metaclass_Velocity(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'LEFT_WHEEL__DEFAULT': 0.0,
            'RIGHT_WHEEL__DEFAULT': 0.0,
        }

    @property
    def LEFT_WHEEL__DEFAULT(cls):
        """Return default value for message field 'left_wheel'."""
        return 0.0

    @property
    def RIGHT_WHEEL__DEFAULT(cls):
        """Return default value for message field 'right_wheel'."""
        return 0.0
...
class Velocity(metaclass=Metaclass_Velocity):
    ...
    def __init__(self, **kwargs):
        ...
        self.left_wheel = kwargs.get(
            'left_wheel', Velocity.LEFT_WHEEL__DEFAULT)
        self.right_wheel = kwargs.get(
            'right_wheel', Velocity.RIGHT_WHEEL__DEFAULT)
    ...
    def left_wheel(self, value):
        if __debug__:
            assert \
                ...
                "The 'left_wheel' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'left_wheel' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def right_wheel(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'right_wheel' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'right_wheel' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
