...
#include "message_interface_robosoccer/msg/detail/velocity__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface_robosoccer::msg::Velocity;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const message_interface_robosoccer::msg::Velocity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_interface_robosoccer::msg::Velocity *>(
    untyped_ros_message);
...
{
  return &message_interface_robosoccer::msg::typesupport_fastrtps_cpp::_Velocity__handle;
}
