...
#include "message_interface_robosoccer/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const message_interface_robosoccer::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  message_interface_robosoccer::msg::Pose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface_robosoccer::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const message_interface_robosoccer::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_interface_robosoccer::msg::Pose *>(
    untyped_ros_message);
...
{
  return &message_interface_robosoccer::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_interface_robosoccer, msg, Pose)() {
  return &message_interface_robosoccer::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
