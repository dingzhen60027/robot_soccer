...
#include "message_interface_robosoccer/msg/detail/image__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const message_interface_robosoccer::msg::Image & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  message_interface_robosoccer::msg::Image & ros_message)
{
  // Member: image
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface_robosoccer::msg::Image;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const message_interface_robosoccer::msg::Image *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_interface_robosoccer::msg::Image *>(
    untyped_ros_message);
...
get_message_type_support_handle<message_interface_robosoccer::msg::Image>()
{
  return &message_interface_robosoccer::msg::typesupport_fastrtps_cpp::_Image__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_interface_robosoccer, msg, Image)() {
  return &message_interface_robosoccer::msg::typesupport_fastrtps_cpp::_Image__handle;
}
