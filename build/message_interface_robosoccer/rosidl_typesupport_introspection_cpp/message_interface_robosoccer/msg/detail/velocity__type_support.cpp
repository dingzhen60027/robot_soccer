...
{
  new (message_memory) message_interface_robosoccer::msg::Velocity(_init);
}

void Velocity_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message_interface_robosoccer::msg::Velocity *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Velocity_message_member_array[2] = {
  {
    ...
    offsetof(message_interface_robosoccer::msg::Velocity, left_wheel),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_interface_robosoccer::msg::Velocity, right_wheel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Velocity_message_members = {
  ...
  2,  // number of fields
  sizeof(message_interface_robosoccer::msg::Velocity),
...
get_message_type_support_handle<message_interface_robosoccer::msg::Velocity>()
{
  return &::message_interface_robosoccer::msg::rosidl_typesupport_introspection_cpp::Velocity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_interface_robosoccer, msg, Velocity)() {
  return &::message_interface_robosoccer::msg::rosidl_typesupport_introspection_cpp::Velocity_message_type_support_handle;
}
