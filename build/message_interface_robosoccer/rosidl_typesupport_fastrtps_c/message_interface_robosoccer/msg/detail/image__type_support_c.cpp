...
#include "message_interface_robosoccer/msg/detail/image__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_message_interface_robosoccer
...
using _Image__ros_msg_type = message_interface_robosoccer__msg__Image;
...
size_t get_serialized_size_message_interface_robosoccer__msg__Image(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Image__ros_msg_type * ros_message = static_cast<const _Image__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Image__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_interface_robosoccer__msg__Image(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_interface_robosoccer
size_t max_serialized_size_message_interface_robosoccer__msg__Image(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface_robosoccer__msg__Image;
    is_plain =
      (
...
static size_t _Image__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_message_interface_robosoccer__msg__Image(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_interface_robosoccer, msg, Image)() {
