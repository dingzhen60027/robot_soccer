...
#include "message_interface_robosoccer/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
using _Pose__ros_msg_type = message_interface_robosoccer__msg__Pose;
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_interface_robosoccer__msg__Pose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = message_interface_robosoccer__msg__Pose;
    is_plain =
      (
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_message_interface_robosoccer__msg__Pose(
